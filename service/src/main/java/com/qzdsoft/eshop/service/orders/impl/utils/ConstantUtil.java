...
public class ConstantUtil {
	//支付api地址
	public static final String PAY_BASICS_URL="http://api.newefu.com" ;
	...
	public static final String APP_BASICS_URL="http://qzdsoft.com";
	...
	//代付请求地址
	public static final String REMIT_BASE_URL = "http://remit.newefu.com";
	...
	//支付秘钥
	public static final String PAY_KEY="bf0AfESdB2PdiNLh";
	
	public static final String MER_NO = "";
	//代付秘钥
